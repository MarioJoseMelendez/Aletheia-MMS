...
// .wrangler/tmp/bundle-3P6qEr/checked-fetch.js
...
// .wrangler/tmp/bundle-3P6qEr/strip-cf-connecting-ip-header.js
...
__name(SyncRoom, "SyncRoom");

// worker/src/index.js
var app = new Hono2();
app.use("*", cors());
var DEFAULT_DEMO_MOLECULES = [
  {
    id: "hemoglobin-demo",
    name: "Hemoglobina",
    description: "Prote\xEDna tetram\xE9rica encargada del transporte de ox\xEDgeno en los gl\xF3bulos rojos.",
    category: "Prote\xEDnas",
  ...
  {
    id: "dna-demo",
    name: "ADN (Doble H\xE9lice B-DNA)",
    description: "Estructura de doble h\xE9lice de \xE1cido desoxirribonucleico conteniendo la informaci\xF3n gen\xE9tica.",
    category: "\xC1cidos Nucleicos",
  ...
  },
  {
    ...
    description: "Mol\xE9cula de ARN encargada de transferir amino\xE1cidos al ribosoma durante la traducci\xF3n.",
    category: "\xC1cidos Nucleicos",
...
var memoryMoleculesStore = [...DEFAULT_DEMO_MOLECULES];
var DEMO_PDB_URLS = {
...
var memoryFileStore = /* @__PURE__ */ new Map();
...
__name(tryGetD1Molecules, "tryGetD1Molecules");
app.get("/ws", (c) => {
  try {
...
app.get("/api/molecules", async (c) => {
  ...
  if (d1Data)
    return c.json({ molecules: d1Data });
...
app.post("/api/molecules", async (c) => {
  try {
    ...
    if (audioFile)
      memoryFileStore.set(audioFilename, audioFile);
    if (c.env.ALETHEIA_STORAGE) {
      try {
        await c.env.ALETHEIA_STORAGE.put(pdbFilename, pdbFile);
        if (audioFile)
          await c.env.ALETHEIA_STORAGE.put(audioFilename, audioFile);
      } catch (e) {
...
// .wrangler/tmp/bundle-3P6qEr/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-3P6qEr/middleware-loader.entry.ts
